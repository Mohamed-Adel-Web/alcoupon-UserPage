...
`
              : `العديد من قسائم الترويج تتطلب قيمة طلب دنيا. هذا يعني أن طلبك يجب أن يكون مساويًا أو يتجاوز مبلغًا معينًا قبل أن تتمكن من تفعيل الخصم. تُحسب القيمة الأدني بناءً على التكلفة الفعلية للعناصر في طلبك بعد أي خصومات فورية، ولا تشمل النفقات الإضافية مثل الضرائب أو الشحن.
              `}
          </Typography>
        </Box>
      </Grid>
